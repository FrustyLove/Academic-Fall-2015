 ...
 *       */
void printS( int num, int frac_bits, int show_bits )
{ 
  unsigned int mask = (1 << frac_bits) - 1;
  unsigned int fracpart;
  unsigned int count = 0;
  //unsigned int mask2 = (1 << (frac_bits-show_bits)) - 1;
  unsigned int mask3 = ( 1 << (frac_bits - show_bits)) - 1; 
  //mask ^=mask2;
